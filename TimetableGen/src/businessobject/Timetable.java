...
public class Timetable {
	...
	public Timetable(List<CourseOffering> courseOfferings, int numConflicts){
		...
		this.numOfDaysWithMorningOff = NumOfDaysWithTimeOff(TimetableComparators.MORE_MORNINGS_OFF, courseOfferings, "F" ,43200, 64800)
				+ NumOfDaysWithTimeOff(TimetableComparators.MORE_MORNINGS_OFF, courseOfferings, "S" ,43200, 64800);
		
		this.numOfDaysWithEveningOff = NumOfDaysWithTimeOff(TimetableComparators.MORE_EVENINGS_OFF, courseOfferings, "F" ,43200, 64800)
	...
	// counts the number of days that don't have the specified time off
		public int NumOfDaysWithTimeOff(TimetableComparators compare, List<CourseOffering> Config, String FirstOrSecond, int noonInSeconds, int eveningInSeconds) {
