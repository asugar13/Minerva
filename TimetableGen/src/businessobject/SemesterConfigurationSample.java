...
public class SemesterConfigurationSample{
	public static void main (String[] args){
		...
		Course c1 = new Course ("Introduction to Software Engineering", "CSC301H1", "description", "CSC209H1", "None", 2017, CampusType.UTSG, SemesterType.FALL, classmap1, breadthlist1);
		Course c2 = new Course ("Computers and Society", "CSC300H1", "description", "Any half course on computing", "None", 2017, CampusType.UTSG, SemesterType.FALL, classmap2, breadthlist2);
		...
		Course c3 = new Course ("Operating Systems", "CSC369H1", "description", "CSC209H1,CSC258H1", "None", 2017, CampusType.UTSG, SemesterType.WINTER, classmap3, breadthlist3);
		...
		breadthlist4.add(5);
		Course c4 = new Course ("Programming on the web", "CSC309H1", "description", "CSC209H1", "None", 2017, CampusType.UTSG, SemesterType.WINTER, classmap4, breadthlist4);
