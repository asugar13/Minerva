...
public class SemesterConfiguration implements TimetableConfiguration{
	...
	//private List<Timetable> possibleTimetables (don't worry about this yet, timetable generator will use this)
	
	public SemesterConfiguration(Set<CourseOffering> semester1, Set<CourseOffering> semester2){
